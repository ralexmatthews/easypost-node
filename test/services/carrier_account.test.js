...
describe("CarrierAccount Service", function () {
  ...
  it("creates a carrier account", async function () {
    const carrierAccount = await this.client.CarrierAccount.create(
  ...
  it("retrieves a carrier account", async function () {
    ...
    const retrievedCarrierAccount = await this.client.CarrierAccount.retrieve(
      carrierAccount.id
    );

    expect(retrievedCarrierAccount.object).to.be.equal("CarrierAccount");
    expect(withoutParams(retrievedCarrierAccount)).to.deep.include(
      withoutParams(carrierAccount)
    );
  ...
  it("updates a carrier account", async function () {
    ...
    await this.client.CarrierAccount.retrieve(carrierAccount.id).then(
      async () => {
        const params = {};
