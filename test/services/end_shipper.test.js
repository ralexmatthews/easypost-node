...
describe("EndShipper Service", function () {
  ...
  it("retrieves an EndShipper object", async function () {
    ...
    const retrievedEndShipper = await this.client.EndShipper.retrieve(
      endShipper.id
    );
  ...
  it("retrieves all EndShipper objects", async function () {
    const endShippers = await this.client.EndShipper.all({
  ...
  it("updates an EndShipper object", async function () {
    ...
    const updatedEndShipper = await this.client.EndShipper.update(
      endShipper.id,
      params
    );
